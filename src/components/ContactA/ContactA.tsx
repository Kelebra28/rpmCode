...
export const Contact = ({ title, phone, email, img, alt }) => {
    ...
    const urlWhatsApp = 'https://api.whatsapp.com/send?phone=+525544887906&text=Hola';

   const descargarContacto = () => {
        const vCard = new VCard();
        vCard.addName('Garcia', 'Ariel');

        const telefono = '+52 5544887906'

        vCard.addPhoneNumber(telefono);
        vCard.addCompany('Rpm Code')
        // vCard.addJobtitle('Software developer')
        vCard.addEmail('arielgarcia960715@gmail.com')
            ...
            <div  className={classes.Info_Container}>
                ...
                <div className={classes.Container_Info}>
                    <div className={classes.Info}>
                        ...
                        <a href="tel:+525544887906" className={classes.Info_Text2}>{phone}</a>
                    </div>
                    <div className={classes.Info}>
                    ...
                    {/* <div className={classes.Info}>
                        ...
                        <a href="https://github.com/Kelebra28" target="_blank" className={classes.Info_Text2}>Git Hub</a>
                    </div> */}
                </div>
            </div>
